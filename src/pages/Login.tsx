...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-6 relative overflow-hidden">
      ...
      <div className="glass-card p-8 w-full max-w-md space-y-6 relative z-10 animate-fade-in">
        <div className="text-center space-y-2">
          <div className="flex items-center justify-center gap-2">
            <Activity className="w-8 h-8 text-primary glow-text" />
            <h1 className="text-3xl font-bold text-primary glow-text">MediAssist AI</h1>
          </div>
          <p className="text-muted-foreground text-sm">Your AI-powered healthcare assistant</p>
        </div>
